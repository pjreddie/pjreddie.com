...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paper.talk'
        db.add_column('papers_paper', 'talk',
                      self.gf('django.db.models.fields.URLField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Paper.talk'
        db.delete_column('papers_paper', 'talk')
    ...
    models = {
        'papers.paper': {
            ...
            'talk': ('django.db.models.fields.URLField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
