...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paper.reviews'
        db.add_column('papers_paper', 'reviews',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Paper.slug'
        db.add_column('papers_paper', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Paper.reviews'
        db.delete_column('papers_paper', 'reviews')

        # Deleting field 'Paper.slug'
        db.delete_column('papers_paper', 'slug')
