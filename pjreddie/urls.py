...
urlpatterns = patterns('',
	...
	url(r'^coq-tactics/$', 'coqindex.views.index', name='coqindex'),
	url(r'^yolo/$', redirect_to, {'url':'/darknet/yolo/'}),
	url(r'^darknet/$', 'darknet.views.posts', name='posts'),
	url(r'^darknet/(?P<slug>[-\w]+)/$', 'darknet.views.post', name='post'),
	url(r'^publications/(?P<slug>[-\w]+)/$', 'papers.views.reviews', name='reviews'),
	...
	(r'^coq-index/(?P<path>.*)$', 'django.views.static.serve',
